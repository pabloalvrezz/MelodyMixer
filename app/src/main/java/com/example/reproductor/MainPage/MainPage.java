...
public class MainPage extends AppCompatActivity {
    ...
    public db_MelodyMixer database;
    static Boolean ModoOscuroActivo = false;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.AcercaDe:
                ...
                break;
            case R.id.Perfil:
                Intent perfil = new Intent(getApplicationContext(), com.example.reproductor.Entities.Perfil.class);
                perfil.putExtra("correo", getUsuarioActual().getCorreo());
                perfil.putExtra("nombre", getUsuarioActual().getUsuario());
                perfil.putExtra("apellidos", getUsuarioActual().getApellidos());
                perfil.putExtra("contraseña", getUsuarioActual().getContraseña());
    ...
    public db_MelodyMixer getDatabase()
    {
        return database;
    }
}
